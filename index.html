...
<html lang="en">
  <head>
    <title>OBR &mdash;Bull Racing</title>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    
    <meta name="description" content="" />
    <meta name="keywords" content="" />
    <meta name="author" content="Oliver Saynisch" />
  ...
  <div class="site-wrap">
    ...
    <header class="site-navbar py-4 js-sticky-header site-navbar-target" role="banner">
      ...
      <div class="container-fluid">
        <div class="d-flex align-items-center">
          <div class="site-logo"><a href="index.html" class="text-uppercase">CESpAPP</a></div>
          <div>
        ...
        <div class="row align-items-center">
          <div class="col-lg-5 mr-auto" data-aos="fade-up">
            ...
            <div class="owl-carousel slide-one-item-alt-text">
              <div class="slide-text">
                ...
                <p><a href="https://free-template.co/" target="_blank" class="btn btn-outline-light py-3 px-5">more information</a></p>
              </div>
              <div class="slide-text">
                <h1>Be safe on your way.</h1>
                <p class="mb-5">Lorem ipsum dolor sit amet consectetur adipisicing elit. Maxime ipsa nulla sed quis rerum amet natus quas necessitatibus.</p>
                <p><a href="https://free-template.co/" target="_blank" class="btn btn-outline-light py-3 px-5">more information</a></p>
              </div>
          ...
          <div class="col-lg-6 ml-auto"  data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="owl-carousel slide-one-item-alt">
              <img src="images/011_CESpa_E-Scooter_kl.jpg" alt="Free Website Template by Free-Template.co" class="img-fluid">
              <img src="images/imsa-road-atlanta-2016-continental-sticker.jpg" alt="Free Website Template by Free-Template.co" class="img-fluid">
              <img src="images/013_CESpa_E-Scooter_kl.jpg" alt="Free Website Template by Free-Template.co" class="img-fluid">
            </div>
    ...
    <div class=" section-1" >
      ...
      <div class="container">
        <div class="row">
          <div class="col-xl-12 mr-auto mb-5"  data-aos="fade-up">

            <div class="col-xl-12">
              <h2 class="section-title">Love Our World</h2>
        ...
        <div class="col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="300">
          <div class="counter d-flex align-items-start">
            ...
            <div class="counter-text">
              ...
              <span>Transmitted Data per Hour</span>
            </div>
          </div>
        </div>

        <div id="air">
          <button type="button" class="btn btn-outline-secondary" onclick="listMarker();">Show Other Drivers</button>
        </div>
        <script>
          //Map initialize
              initMap(49.477242, 11.117943, 800);  
              //Business Logic
                var logicTimer = setInterval(run, 1000);
        </script>
      </div>
    </div>

    <div class="margin-top" id="work-section " data-aos="fade">
      <div class="container">
        <div class="row">
    ...
    <div class="row text-center" >
        <div class="col-3"></div>
        <div class="col-lg-2"><p class="font-weight-bold " id="text">Distance</p></div>
        <div class="col-lg-2"><p class="font-weight-bold " id="text">Battery</p></div>
        <div class="col-lg-2"><p class="font-weight-bold " id="text">Temperature</p></div>
      ...
      <div class="container">
        <div class="row text-center justify-content-center mb-5"  data-aos="fade-up">
          <div class="col-lg-6 mb-5 text-center">
            <h2 class="section-title w-100 mx-auto">Safety</h2>
            ...
            <div class="owl-carousel slide-one-item-alt-text">
              <div class="slide-text">
                <blockquote>
                  ...
                  <p class="author">&mdash;  Oliver</p>
                </blockquote>
              </div>
              <div class="slide-text">
                <blockquote>
                  <p><span>&ldquo;</span>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dignissimos corrupti, obcaecati repudiandae, animi ad quos. Eius expedita ipsa qui autem.<span>&rdquo;</span></p>
                  <p class="author">&mdash;  Alex</p>
                </blockquote>
              </div>
              <div class="slide-text">
               <blockquote>
                  <p><span>&ldquo;</span>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dignissimos corrupti, obcaecati repudiandae, animi ad quos. Eius expedita ipsa qui autem.<span>&rdquo;</span></p>
                  <p class="author">&mdash;  Lukas</p>
                </blockquote>
              </div>
              <div class="slide-text">
                <blockquote>
                  <p><span>&ldquo;</span>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dignissimos corrupti, obcaecati repudiandae, animi ad quos. Eius expedita ipsa qui autem.<span>&rdquo;</span></p>
                  <p class="author">&mdash;  Brijesh</p>
                </blockquote>
              </div>
            </div>
        ...
        <div class="row">
          ...
          <div class="col-md-3 ml-auto">
            ...
            <ul class="list-unstyled footer-links">
              ...
              <li><a href="#work-section" class="smoothscroll">General Information</a></li>
              <li><a href="#process-section" class="smoothscroll">Eco Monitor</a></li>
              <li><a href="#testimonials-section" class="smoothscroll">Safety and Navigation</a></li>
            </ul>
          </div>
